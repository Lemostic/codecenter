---
description: 本项目架构配置 — Monorepo 包路径（@mdm/core/@mdm/common）、技术栈版本锁定（含 Formily）、Config Provider 体系、Auth/HTTP 模块、Dm-* 组件命名、页面后缀铁律、路由规范、Composable 签名。
paths:
  - "**/*.vue"
  - "**/*.ts"
---
