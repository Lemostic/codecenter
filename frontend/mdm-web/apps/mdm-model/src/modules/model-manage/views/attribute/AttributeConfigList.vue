...
const columns: TpTableColumn[] = [
  ...
  { prop: 'dataTypeLabel', label: '数据类型', minWidth: 110 },
  { prop: 'dataLength', label: '长度', minWidth: 70 },
  { prop: 'decimalLength', label: '精度', minWidth: 70 },
  { prop: 'positiveOnly', label: '仅为正数', minWidth: 80 },
  { prop: 'isRequired', label: '是否必填', minWidth: 80 },
  { prop: 'isUnique', label: '是否唯一', minWidth: 80 },
  { prop: 'comment', label: '注释', minWidth: 140, showOverflowTooltip: true },
  { prop: 'statusLabel', label: '状态', minWidth: 80 },
